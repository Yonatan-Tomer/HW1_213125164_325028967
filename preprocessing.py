...
class FeatureStatistics:
    ...
    def count_feature_data(self, feature_data, feature_class):
        ...
        """
        if feature_class in self.feature_rep_dict:
...
class Feature2id:
    def __init__(self, feature_statistics: FeatureStatistics, threshold: int, feature_classes):
        """
...
def append_idx_if_exists(feature_data, feature_class: str, dict_of_dicts: Dict[str, Dict[Tuple[str, str], int]],
    ...
    """
    if feature_class in dict_of_dicts and feature_data in dict_of_dicts[feature_class]:
        features.append(dict_of_dicts[feature_class][feature_data])


def preprocess_train(train_path, threshold, feature_classes):
    # Statistics
    statistics = FeatureStatistics(feature_classes)
    statistics.get_word_tag_pair_count(train_path)

    # feature2id
    feature2id = Feature2id(statistics, threshold, feature_classes)
